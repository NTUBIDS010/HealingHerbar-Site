...
// ✅ 問卷問題
const questions = [
    { text: "🌿 最近是不是睡不好呢？告訴安爺爺您的睡覺時間～（若要跳過此題可以點選「下一題」）", key: "睡不好", type: "single", options: ["憂鬱最嚴重", "焦慮", "容易緊張", "無"] },
    { text: "🌿 您半夜是不是難以入眠，或是到半夜還在嗨？（若要跳過此題可以點選「下一題」）", key: "半暝還在嗨", type: "single", options: ["22點以前", "22-24點", "24-3點", "3點以後"] },
    { text: "🌿 您早上會不會打噴嚏或是有其他像是胸悶的狀況？（若要跳過此題可以點選「下一題」）", key: "早上哈啾", type: "single", options: ["長期有呼吸胸悶", "偶發有呼吸胸悶", "無"] },
    { text: "🌿 您的皮膚是否容易過敏？時常感覺皮在癢呀？（若要跳過此題可以點選「下一題」）", key: "癢癢", type: "single", options: ["長期過敏", "短期過敏", "無"] },
    { text: "🌿 您最近胃部是否有不適？是可以複選的選項唷！所以可以選擇選項後，再點下一題！（若要跳過此題可以點選「下一題」）", key: "胃生氣", type: "multiple", options: ["胃脹氣", "反胃", "胃食道逆流", "無"] },
    { text: "🌿 您來大姨媽的時候會不會覺得肚子痛呢？（若要跳過此題可以點選「下一題」）", key: "厭世生理期", type: "single", options: ["重度疼痛", "輕度疼痛", "不會痛", "無生理期"] },
    { text: "🌿 您可以接受有苦味的飲品嗎？把吃苦當吃補！（若要跳過此題可以點選「下一題」）", key: "接受苦的程度", type: "single", options: ["可以", "不行"] }
];
